...
/** P3.3 launch batch */
const LAUNCHED_CONDITION_SLUGS = ['back-pain-treatment', 'neck-pain-treatment'];

const CONDITION_CONFIG = {
  'back-pain-treatment': {
    h1: 'Պոզանոցի ցավ և վերականգնում',
    tagline: 'Կոնսերվատիվ մոտեցում պոզանոցի և գոտկային ցավի գնահատման և վերականգնման համար Երևանում',
    titleSuffix: 'Պոզանոցի ցավ — վերականգնում և խորհրդատվություն',
    description:
    ...
    servicesIntro:
      'Պոզանոցի ցավի դեպքում վերականգնողական կենտրոնում կարող են դիտարկվել հետևյալ ծառայությունները՝ միայն մասնագետի գնահատումից հետո։ Դրանք հաճախ կիրառվում են որպես կոնսերվատիվ պլանի մաս և կարող են համակցվել միմյանց։'
  },
  'neck-pain-treatment': {
    h1: 'Պարանոցի ցավ և վերականգնում',
    tagline: 'Կոնսերվատիվ մոտեցում պարանոցի ցավի, կոկորկոտման և շարժունակության խնդիրների գնահատման համար',
    titleSuffix: 'Պարանոցի ցավ — վերականգնում և խորհրդատվություն',
    description:
      'Պարանոցի ցավի և կոկորկոտման գնահատում և վերականգնողական աջակցություն «Առողջ ողնաշար» կենտրոնում Երևանում։ Մանուալ թերապիա, ֆիզիոթերապիա, օստեոպաթիա։',
...
function ctaBlock() {
  return `<nav class="seo-service-cta" aria-label="Next steps">
    <p><a href="/appointment.html" class="hss-btn hss-btn--primary">Գրանցվել ընդունելության</a>
...
function hubMeta(data) {
  ...
  return {
    ...
    description:
      'Պոզանոցի և պարանոցի ցավի վերաբերյալ տեղեկատվություն և վերականգնողական խորհրդատվություն «Առողջ ողնաշար» կենտրոնում Երևանում։',
