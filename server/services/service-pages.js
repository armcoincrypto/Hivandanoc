...
function serviceAudienceParagraph(service) {
  const bySlug = {
    ...
    'hernia-treatment':
      'Պոզանոցի հերնիայի կոնսերվատիվ բուժման ծրագիրը կարող է ներառվել այն հիվանդների համար, ում համար նախընտրելի է ոչ վիրահատական մոտեցում և մասնագիտական հսկողություն։ Յուրաքանչյուր դեպք գնահատվում է առանձին՝ հաշվի առնելով ախտորոշումը և բողոքները։',
    scoliosis:
...
function serviceCarePathParagraph(service) {
  const paths = {
    ...
    'hernia-treatment':
      'Պոզանոցի հերնիայի կոնսերվատիվ ծրագրի դեպքում կարևոր է հաշվի առնել ախտորոշման տեսակը, ցավի ինտենսիվությունը և նյարդային ախտանիշների առկայությունը։ Մասնագետը կարող է խորհուրել տրակցիա, վերականգնողական վարժություններ, ֆիզիոթերապիա կամ այլ մեթոդներ՝ ըստ անհատական գնահատման։',
    scoliosis:
